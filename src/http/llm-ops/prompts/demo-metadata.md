...
The highlighted element with black border is where user performed a click. The highlight effect is shown by creating a transparent overlay on the clicked element there by creating dark overlay on the rest of the screen. There might be some other marks with red, blue and cyan rectangles that you can completely ignore.
